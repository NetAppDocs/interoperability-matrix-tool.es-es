...
summary: La pestaña *Toolbox* te muestra una lista de herramientas útiles divididas en tres categorías de usuario. Se muestra un vínculo para cada herramienta. 
---
